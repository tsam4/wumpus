#ifndef CATEGORICAL_HPP
#define CATEGORICAL_HPP
...
/**
 * An abstract base class to group all general discrete factors.
 */
class Categorical : public Factor {
...
public:
   ...
   */
  virtual Categorical* copy(const emdw::RVIds& newVars = {},
...
public:
  ...
  //  */
  // virtual Categorical* vacuousCopy() const = 0;
